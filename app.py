...
feature_translation = {
    ...
    "avg_comments": "Среднее число комментариев",
    ...
    "ads_ratio": "Доля рекламы",
    "attachments_ratio": "Доля прикреплённых файлов",
    "avg_text_uniqueness": "Средняя уникальность текста",
